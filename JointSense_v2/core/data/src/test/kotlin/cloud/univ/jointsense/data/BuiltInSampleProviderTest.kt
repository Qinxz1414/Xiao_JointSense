...
class BuiltInSampleProviderTest {
    ...
    private companion object {
        val GOLDEN_SESSIONS = listOf(
            goldenSession("builtin-tc1", "builtin-tc1", 1_785_240_000_000L, 0f, 142f, 0f, 143f, 0f, 139f),
            goldenSession("builtin-tc2", "builtin-tc2", 1_785_326_400_000L, 2f, 142.4f, 5f, 143.3f, 2f, 141.8f),
            goldenSession("builtin-tc3", "builtin-tc3", 1_785_412_800_000L, 5f, 143f, 10f, 143.6f, 5f, 146f),
            goldenSession("builtin-tc4", "builtin-tc4", 1_785_499_200_000L, 10f, 144f, 20f, 144.2f, 10f, 153f),
            goldenSession("builtin-tc5", "builtin-tc5", 1_785_585_600_000L, 20f, 146f, 50f, 146f, 20f, 167f),
            goldenSession("builtin-tc6", "builtin-tc6", 1_785_672_000_000L, 50f, 150f, 100f, 150f, 50f, 167f),
            goldenSession("builtin-tc7", "builtin-tc7", 1_785_758_400_000L, 100f, 170f, 200f, 150f, 100f, 170f),
            goldenSession("builtin-tc8", "builtin-tc8", 1_785_844_800_000L, 200f, 176f, 500f, 161f, 200f, 183f),
            goldenSession("builtin-tc9", "builtin-tc9", 1_785_931_200_000L, 500f, 176f, 1000f, 161f, 500f, 183f),
            goldenSession("builtin-clip-1", "builtin-clip-1", 1_786_015_500_000L, 0f, 142f, 0f, 143f, 0f, 139f),
            goldenSession("builtin-clip-2", "builtin-clip-2", 1_786_015_860_000L, 15f, 145f, 0f, 143f, 7.142857f, 149f),
            goldenSession("builtin-clip-3", "builtin-clip-3", 1_786_029_600_000L, 50f, 150f, 75f, 148f, 130.76923f, 174f),
        )
